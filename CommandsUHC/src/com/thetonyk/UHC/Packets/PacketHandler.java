...
import com.thetonyk.UHC.Packets.ReflectionUtils.FieldAccessor;
import com.thetonyk.UHC.Packets.ReflectionUtils.MethodInvoker;
...
public abstract class PacketHandler {
	...
	private static final MethodInvoker getPlayerHandle = ReflectionUtils.getMethod("{obc}.entity.CraftPlayer", "getHandle");
	private static final FieldAccessor<Object> getConnection = ReflectionUtils.getField("{nms}.EntityPlayer", "playerConnection", Object.class);
	private static final FieldAccessor<Object> getManager = ReflectionUtils.getField("{nms}.PlayerConnection", "networkManager", Object.class);
	private static final FieldAccessor<Channel> getChannel = ReflectionUtils.getField("{nms}.NetworkManager", Channel.class, 0);
	...
	private static final FieldAccessor<Object> getMinecraftServer = ReflectionUtils.getField("{obc}.CraftServer", minecraftServerClass, 0);
	private static final FieldAccessor<Object> getServerConnection = ReflectionUtils.getField(minecraftServerClass, serverConnectionClass, 0);
	private static final MethodInvoker getNetworkMarkers = ReflectionUtils.getTypedMethod(serverConnectionClass, null, List.class, serverConnectionClass);

	// Packets we have to intercept
	private static final Class<?> PACKET_LOGIN_IN_START = ReflectionUtils.getMinecraftClass("PacketLoginInStart");
	private static final FieldAccessor<GameProfile> getGameProfile = ReflectionUtils.getField(PACKET_LOGIN_IN_START, GameProfile.class, 0);
